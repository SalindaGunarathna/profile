...
export function ProjectCatogary() {
    return (
        <div className="h-[50rem] w-full bg-black bg-black  dark:bg-dot-white/[0.5] bg-dot-black/[0.2] relative flex items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-4 items-center">
                <div className="max-w-xs w-full md:w-auto p-4 sm:p-6">
                    ...
                    <BackgroundGradient className="rounded-[22px] p-4 sm:p-6 bg-black dark:bg-zinc-900">
                        <img
                            src={mobiledev}
                            alt="jordans"
                        ...
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 text-white">
